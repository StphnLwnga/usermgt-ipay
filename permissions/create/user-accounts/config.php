<?php
	...
	// connect to database
	$conn = new mysqli("localhost", "accounts", "0725313208Evance!", "slashdotpro_user_accounts");
	// Check connection
  ...
  // define global constants
	...
	define('BASE_URL', 'http://ipay.slashdotlabsprojects.com/permissions/create/user-accounts/'); 
